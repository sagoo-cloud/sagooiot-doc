...
sidebar_position: 6
hide_title: true
keywords: [规则引擎,条件分支,条件路由,表达式路由,分支判断,智能路由,条件表达式,路由规则,分支配置,流程控制]
description: '详细介绍SagooIOT平台规则引擎中条件分支节点的功能和使用方法，包括条件表达式配置、分支路由、使用场景、最佳实践等内容，帮助用户实现基于条件表达式的智能消息路由。'
---
